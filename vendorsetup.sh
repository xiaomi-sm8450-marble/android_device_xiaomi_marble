...
echo 'Cloning Hardware Dolby Tree'
	git clone https://github.com/xiaomi-sm8450-marble/android_hardware_dolby.git -b aospa hardware/dolby
...
echo 'Cloning Vendor Tree'
	git clone https://github.com/beingashwani/proprietary_vendor_xiaomi_marble -b lineage-22.2 vendor/xiaomi/marble
